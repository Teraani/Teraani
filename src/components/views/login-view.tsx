...
const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48" {...props}>
        ...
        <path fill="#1976D2" d="M43.611 20.083H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.571l6.19 5.238C44.598 32.791 48 27.461 48 20c0-1.341-.138-2.65-.389-3.917z"></path>
    </svg>
);
        ...
        <div className="w-full max-w-sm mx-auto">
            ...
            <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-gray-100 dark:bg-zinc-900 px-2 text-gray-500">
                        Ou continue com
                    </span>
                </div>
            </div>
