          ...
          return (
            <Card
              ...
              className={cn(
                ...
                !isLeagueAdmin && "cursor-not-allowed bg-black/10 text-primary-foreground/50"
              )}
            ...
            >
              <CardHeader>
                ...
                <CardDescription className={cn(!isLeagueAdmin ? "text-primary-foreground/50" : "text-primary-foreground/80")}>{modality.description}</CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardFooter>
                 <Button
                  ...
                  >
                      {!isLeagueAdmin && <Lock className="w-4 h-4 mr-2"/>}
                      {isSelected ? 'Confirmado' : (!isLeagueAdmin ? 'Aguardando Admin' : 'Confirmar Modalidade')}
                  </Button>
              </CardFooter>
            </Card>
          );
