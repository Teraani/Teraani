...
export const defaultLeagueData: League = {
    ...
    paymentEditor: null,
    players: {
      'p1': { name: 'Rafael Ohy', team: 'AVA', pos: 'MEI', value: 49.5, points: 48, last_val: 0.5, games: 21, img: 'https://placehold.co/60x60', stats: { wins: 15, losses: 3, draws: 3, goalsFor: 60, goalsAgainst: 46, goalDifference: 14, performance: 78.57, points: 48, goals: 10, assists: 10, yellowCards: 1, redCards: 0 }, performanceHistory: [] },
      ...
      'p4': { name: 'Rossi', team: 'FLA', pos: 'VOL', value: 27, points: 28, last_val: 0.5, games: 15, img: 'https://placehold.co/60x60', stats: { wins: 9, losses: 5, draws: 1, goalsFor: 37, goalsAgainst: 37, goalDifference: 0, performance: 60, points: 28, goals: 8, assists: 7, yellowCards: 1, redCards: 0 }, performanceHistory: [] },
      'p5': { name: 'Gustavo Rodrigues', team: 'CRI', pos: 'VOL', value: 34.5, points: 28, last_val: 0.5, games: 20, img: 'https://placehold.co/60x60', stats: { wins: 8, losses: 8, draws: 4, goalsFor: 56, goalsAgainst: 50, goalDifference: 6, performance: 57.5, points: 28, goals: 5, assists: 9, yellowCards: 1, redCards: 0 }, performanceHistory: [] },
      'p6': { name: 'Vinícius Simão', team: 'FLU', pos: 'LAT', value: 30, points: 28, last_val: 0.5, games: 20, img: 'https://placehold.co/60x60', stats: { wins: 8, losses: 8, draws: 4, goalsFor: 49, goalsAgainst: 44, goalDifference: 5, performance: 55.56, points: 28, goals: 0, assists: 1, yellowCards: 2, redCards: 0 }, performanceHistory: [] },
      'p7': { name: 'Adriano Carvalho', team: 'FOR', pos: 'ATA', value: 36, points: 31, last_val: 0.5, games: 22, img: 'https://placehold.co/60x60', stats: { wins: 9, losses: 9, draws: 4, goalsFor: 58, goalsAgainst: 52, goalDifference: 6, performance: 54.55, points: 31, goals: 15, assists: 2, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      'p8': { name: 'Deyvid Gontarczik Deca', team: 'GOI', pos: 'ATA', value: 30, points: 29, last_val: 0.5, games: 20, img: 'https://placehold.co/60x60', stats: { wins: 9, losses: 9, draws: 2, goalsFor: 58, goalsAgainst: 53, goalDifference: 5, performance: 50, points: 29, goals: 19, assists: 6, yellowCards: 1, redCards: 0 }, performanceHistory: [] },
      'p9': { name: 'Felipe Ropeiro (Cabanhas)', team: 'JUV', pos: 'MEI', value: 31.5, points: 30, last_val: 0.5, games: 22, img: 'https://placehold.co/60x60', stats: { wins: 9, losses: 10, draws: 3, goalsFor: 53, goalsAgainst: 54, goalDifference: -1, performance: 47.73, points: 30, goals: 8, assists: 5, yellowCards: 1, redCards: 0 }, performanceHistory: [] },
      'p10': { name: 'Vinícius Abreu', team: 'SAN', pos: 'ATA', value: 28.5, points: 26, last_val: 0.5, games: 20, img: 'https://placehold.co/60x60', stats: { wins: 8, losses: 10, draws: 2, goalsFor: 55, goalsAgainst: 58, goalDifference: -3, performance: 45.24, points: 26, goals: 19, assists: 7, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      'p11': { name: 'Bruno Costa (Bruneca)', team: 'VIT', pos: 'ZAG', value: 27, points: 20, last_val: 0.5, games: 20, img: 'https://placehold.co/60x60', stats: { wins: 6, losses: 12, draws: 2, goalsFor: 46, goalsAgainst: 52, goalDifference: -6, performance: 45, points: 20, goals: 0, assists: 0, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      'p12': { name: 'Felipe Correa', team: 'FLA', pos: 'VOL', value: 19.5, points: 15, last_val: 0.5, games: 15, img: 'https://placehold.co/60x60', stats: { wins: 4, losses: 7, draws: 3, goalsFor: 36, goalsAgainst: 40, goalDifference: -4, performance: 43.33, points: 15, goals: 1, assists: 2, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      'p13': { name: 'Alexandre Santos', team: 'CRU', pos: 'ZAG', value: 21, points: 20, last_val: 0.5, games: 17, img: 'https://placehold.co/60x60', stats: { wins: 6, losses: 9, draws: 2, goalsFor: 40, goalsAgainst: 51, goalDifference: -11, performance: 41.18, points: 20, goals: 0, assists: 1, yellowCards: 3, redCards: 0 }, performanceHistory: [] },
      'p14': { name: 'Vicente Gagliardi (Pizza)', team: 'PAL', pos: 'ATA', value: 13.5, points: 13, last_val: 0.5, games: 13, img: 'https://placehold.co/60x60', stats: { wins: 4, losses: 8, draws: 1, goalsFor: 38, goalsAgainst: 47, goalDifference: -9, performance: 34.62, points: 13, goals: 6, assists: 2, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      'p15': { name: 'Gustavo Reis (Titânio)', team: 'COR', pos: 'LAT', value: 19.5, points: 21, last_val: 0.5, games: 21, img: 'https://placehold.co/60x60', stats: { wins: 6, losses: 12, draws: 3, goalsFor: 46, goalsAgainst: 58, goalDifference: -12, performance: 34.21, points: 21, goals: 0, assists: 2, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      'p16': { name: 'Isaias Souza', team: 'INT', pos: 'MEI', value: 18, points: 17, last_val: 0.5, games: 19, img: 'https://placehold.co/60x60', stats: { wins: 5, losses: 12, draws: 2, goalsFor: 39, goalsAgainst: 53, goalDifference: -14, performance: 31.58, points: 17, goals: 3, assists: 4, yellowCards: 2, redCards: 0 }, performanceHistory: [] },
      'p17': { name: 'Beto', team: 'GRE', pos: 'MEI', value: 10.5, points: 10, last_val: 0.5, games: 15, img: 'https://placehold.co/60x60', stats: { wins: 3, losses: 11, draws: 1, goalsFor: 35, goalsAgainst: 48, goalDifference: -13, performance: 23.33, points: 10, goals: 3, assists: 4, yellowCards: 1, redCards: 0 }, performanceHistory: [] },
      ...
      'p19': { name: 'Thiago Santos', team: 'VAS', pos: 'MEI', value: 4.5, points: 3, last_val: 0.5, games: 2, img: 'https://placehold.co/60x60', stats: { wins: 1, losses: 1, draws: 0, goalsFor: 4, goalsAgainst: 3, goalDifference: 1, performance: 75, points: 3, goals: 1, assists: 0, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      'p20': { name: 'Carlos Souza', team: 'AVA', pos: 'Mei / Lat', value: 4.5, points: 3, last_val: 0.5, games: 2, img: 'https://placehold.co/60x60', stats: { wins: 1, losses: 1, draws: 0, goalsFor: 4, goalsAgainst: 3, goalDifference: 1, performance: 75, points: 3, goals: 0, assists: 0, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      'p21': { name: 'Heitor (Totti)', team: 'BOT', pos: 'ATA', value: 21, points: 18, last_val: 0.5, games: 10, img: 'https://placehold.co/60x60', stats: { wins: 6, losses: 4, draws: 0, goalsFor: 25, goalsAgainst: 19, goalDifference: 6, performance: 70, points: 18, goals: 2, assists: 0, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      'p22': { name: 'Juliano Vello', team: 'CAM', pos: 'LAT', value: 22.5, points: 13, last_val: 0.5, games: 12, img: 'https://placehold.co/60x60', stats: { wins: 4, losses: 7, draws: 1, goalsFor: 27, goalsAgainst: 25, goalDifference: 2, performance: 65, points: 13, goals: 0, assists: 1, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      ...
      'p24': { name: 'Érico', team: 'CRI', pos: 'VOL', value: 7.5, points: 6, last_val: 0.5, games: 4, img: 'https://placehold.co/60x60', stats: { wins: 2, losses: 2, draws: 0, goalsFor: 7, goalsAgainst: 5, goalDifference: 2, performance: 62.5, points: 6, goals: 1, assists: 1, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      'p25': { name: 'Lucas Limone', team: 'FLU', pos: 'LAT', value: 7.5, points: 6, last_val: 0.5, games: 4, img: 'https://placehold.co/60x60', stats: { wins: 2, losses: 2, draws: 0, goalsFor: 14, goalsAgainst: 13, goalDifference: 1, performance: 62.5, points: 6, goals: 1, assists: 1, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
      ...
      'p28': { name: 'Giovani', team: 'GOI', pos: 'LAT', value: 1.5, points: 3, last_val: 0.5, games: 7, img: 'https://placehold.co/60x60', stats: { wins: 1, losses: 6, draws: 0, goalsFor: 12, goalsAgainst: 31, goalDifference: -19, performance: 21.43, points: 3, goals: 0, assists: 0, yellowCards: 0, redCards: 0 }, performanceHistory: [] },
