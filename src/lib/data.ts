...
export const data: AppData = {
    users: {
        ...
        'user27': { id: 'user27', name: 'Jason', email: 'user27@example.com', teamName: 'User 27 FC', partialScore: 0, totalScore: 0, valuation: 100, lineup: [], reserves: [], role: 'player', avatar: 'https://placehold.co/128x128.png' },
    ...
    players: {
      ...
      'p4': { name: 'Rossi', team: 'FLA', pos: 'VOL', value: 27, points: 27, last_val: 0.5, games: 15, img: 'https://placehold.co/60x60', stats: { wins: 9, losses: 5, draws: 1, goalsFor: 37, goalsAgainst: 37, goalDifference: 0, performance: 60, points: 27, goals: 8, assists: 2, yellowCards: 1, redCards: 0 } },
      ...
      'p7': { name: 'Adriano Carvalho', team: 'FOR', pos: 'ATA', value: 36, points: 36, last_val: 0.5, games: 22, img: 'https://placehold.co/60x60', stats: { wins: 9, losses: 9, draws: 4, goalsFor: 58, goalsAgainst: 52, goalDifference: 6, performance: 54.55, points: 36, goals: 0, assists: 2, yellowCards: 0, redCards: 0 } },
      'p8': { name: 'Deyvid Gontarczik (Deca)', team: 'GOI', pos: 'ATA', value: 30, points: 30, last_val: 0.5, games: 20, img: 'https://placehold.co/60x60', stats: { wins: 9, losses: 9, draws: 2, goalsFor: 58, goalsAgainst: 53, goalDifference: 5, performance: 50, points: 30, goals: 15, assists: 5, yellowCards: 1, redCards: 0 } },
      'p9': { name: 'Felipe Ropeiro (Cabanhas)', team: 'JUV', pos: 'MEI', value: 31.5, points: 31.5, last_val: 0.5, games: 22, img: 'https://placehold.co/60x60', stats: { wins: 9, losses: 10, draws: 3, goalsFor: 53, goalsAgainst: 54, goalDifference: -1, performance: 47.73, points: 31.5, goals: 7, assists: 5, yellowCards: 1, redCards: 0 } },
      'p10': { name: 'Vinícius Abreu', team: 'SAN', pos: 'ATA', value: 28.5, points: 28.5, last_val: 0.5, games: 20, img: 'https://placehold.co/60x60', stats: { wins: 8, losses: 10, draws: 2, goalsFor: 55, goalsAgainst: 58, goalDifference: -3, performance: 45.24, points: 28.5, goals: 18, assists: 7, yellowCards: 0, redCards: 0 } },
      'p11': { name: 'Bruno Costa (Bruneca)', team: 'VIT', pos: 'ZAG', value: 27, points: 27, last_val: 0.5, games: 20, img: 'https://placehold.co/60x60', stats: { wins: 6, losses: 12, draws: 2, goalsFor: 46, goalsAgainst: 52, goalDifference: -6, performance: 45, points: 27, goals: 0, assists: 1, yellowCards: 0, redCards: 0 } },
      ...
      'p13': { name: 'Alexandre Santos', team: 'CRU', pos: 'ZAG', value: 21, points: 21, last_val: 0.5, games: 17, img: 'https://placehold.co/60x60', stats: { wins: 6, losses: 9, draws: 2, goalsFor: 40, goalsAgainst: 51, goalDifference: -11, performance: 41.18, points: 21, goals: 1, assists: 1, yellowCards: 3, redCards: 0 } },
      ...
      'p17': { name: 'Beto', team: 'GRE', pos: 'MEI', value: 10.5, points: 10.5, last_val: 0.5, games: 15, img: 'https://placehold.co/60x60', stats: { wins: 3, losses: 11, draws: 1, goalsFor: 35, goalsAgainst: 48, goalDifference: -13, performance: 23.33, points: 10.5, goals: 3, assists: 2, yellowCards: 1, redCards: 0 } },
      'p18': { name: 'Diego Nunes', team: 'SAO', pos: 'ATA', value: 4.5, points: 4.5, last_val: 0.5, games: 4, img: 'https://placehold.co/60x60', stats: { wins: 3, losses: 1, draws: 0, goalsFor: 5, goalsAgainst: 1, goalDifference: 4, performance: 75, points: 4.5, goals: 1, assists: 0, yellowCards: 0, redCards: 0 } },
      ...
      'p20': { name: 'Carlos Souza', team: 'AVA', pos: 'Mei / Lat', value: 4.5, points: 4.5, last_val: 0.5, games: 2, img: 'https://placehold.co/60x60', stats: { wins: 1, losses: 1, draws: 0, goalsFor: 4, goalsAgainst: 3, goalDifference: 1, performance: 75, points: 4.5, goals: 1, assists: 0, yellowCards: 0, redCards: 0 } },
      ...
      'p24': { name: 'Érico', team: 'CRI', pos: 'VOL', value: 7.5, points: 7.5, last_val: 0.5, games: 4, img: 'https://placehold.co/60x60', stats: { wins: 2, losses: 2, draws: 0, goalsFor: 7, goalsAgainst: 5, goalDifference: 2, performance: 62.5, points: 7.5, goals: 0, assists: 1, yellowCards: 0, redCards: 0 } },
      ...
      'p28': { name: 'Giovani', team: 'GOI', pos: 'LAT', value: 1.5, points: 1.5, last_val: 0.5, games: 7, img: 'https://placehold.co/60x60', stats: { wins: 1, losses: 6, draws: 0, goalsFor: 12, goalsAgainst: 31, goalDifference: -19, performance: 21.43, points: 1.5, goals: 1, assists: 1, yellowCards: 0, redCards: 0 } },
